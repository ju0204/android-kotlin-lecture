...
class _State extends State<ImagePage> {
    ...
    switch (_selection) {
      ...
      default:
        return Image.network(
            "https://www.hansung.ac.kr/html/themes/www/img/main/logo.gif");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text(ImagePage.menu_name), actions: [
          PopupMenuButton<_ImageAsset>(
            onSelected: (_ImageAsset result) {
              setState(() {
                _selection = result;
              });
            },
            itemBuilder: (BuildContext context) =>
                <PopupMenuEntry<_ImageAsset>>[
        ...
        body: Center(child: _selectedImage()));
  }
}
